package io.vamani.worker.application.repository;

import io.vamani.worker.application.WorkerrecruitmentApp;
import io.vamani.worker.application.config.Constants;
import io.vamani.worker.application.config.audit.AuditEventConverter;
import io.vamani.worker.application.domain.PersistentAuditEvent;
...
import static io.vamani.worker.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
